...
# It hates me for wanting me for wanting to use my local image.
# In order to get that done, I have to jump through the following hoops:
...
# then I manually edited the file to have the updated imagePullPolicy
